...
void setup() {
  ...
  // Write "Hey Mario!" into toad
  writeFile(SD, "/toad.txt", "Hey ");
  appendFile(SD, "/toad.txt", "Mario!\n");
  
  // Read what toad said
  readFile(SD, "/toad.txt");

  // Rename peach into toad
  renameFile(SD, "/toad.txt", "/peach.txt");

  // Rewrite toad
  writeFile(SD, "/toad.txt", "I'm sorry but princess peach is in another castle!\n");

  // Read what toad said
  readFile(SD, "/toad.txt");

  // Blank file for IO test
